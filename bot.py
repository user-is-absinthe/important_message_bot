...
async def cmd_start(m: Message):
    ...
    await m.answer(
        "Привет! Я нужен, чтобы ты мог сохранить, а потом в диалоге быстро использовать картинку "
        "для важных переговоров.\n\n"
        "Как пользоваться:\n"
        "• Пришли фото с тегами — я сохраню их.\n"
        f"• Затем в inline-режиме (набери {mention} в любом чате) ищи по своим тегам.\n"
        "• Чтобы отредактировать/удалить — пришли картинку в чат со мной через inline, я покажу кнопки.\n"
        "• Так же есть несколько режимов сохранения тегов, посмотри клавиатуру.",
...
async def cmd_help(m: Message):
    ...
    await m.answer(
        ...
        "Для изменения режима сохранения тегов воспользуйся клавиатурой.\n"
        "\n"
